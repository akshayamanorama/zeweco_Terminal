...
export const RouteLine: React.FC<RouteLineProps> = ({ progress, health }) => {
  ...
  return (
    <div className="flex items-center gap-3 w-full group">
      <span className="text-[9px] text-zinc-400 dark:text-zinc-600 font-bold tracking-tighter uppercase">Start</span>
      ...
      <span className="text-[9px] text-zinc-400 dark:text-zinc-600 font-bold tracking-tighter uppercase">Goal</span>
    </div>
  );
};
